...
function Carrito() {
  ...
  const onFormSubmit = (event) => {
    ...
    const selectedProduct = event.target.producto.value;
    const [productName, productPrice] = selectedProduct.split(',');
    const quantity = parseInt(event.target.cantidad.value, 10);

    const existingCartItemIndex = cartItems.findIndex(item => item.productName === productName);
    if (existingCartItemIndex !== -1) {
      ...
      const newItem = { productName, productPrice, quantity };
                        ...
                        <div className="row">
                          <div>
                            ...
                            <select id="producto" className="form-select">
                              ...
                              <option value="YAMAHA FZ15,1000000">YAMAHA FZ15</option>
                              <option value="YAMAHA FZ25,2000000">YAMAHA FZ25</option>
                              <option value="YAMAHA MT03,3000000">YAMAHA MT03</option>
                              <option value="YAMAHA NMAX,3000000">YAMAHA NMAX</option>
                              <option value="YAMAHA TRACER09,4000000">YAMAHA TRACER09</option>
                            </select>
